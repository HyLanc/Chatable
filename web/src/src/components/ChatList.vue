<template>
            ...
            <ul class="list-inline">
                <el-badge :value="noteCount">
                    <li class="list-inline-item" @click="showNoteContent = true">
                        <a class="btn btn-outline-light" data-toggle="tooltip" title="Notification">
                            ...
                            <li v-if="item.unreadReceiver > 0" :class="chatId === item.id ? 'list-group-item open-chat' : 'list-group-item'" @click="changeChatIndex(item.id, item.sender)">
                                ...
                                <div>
                                    <el-dropdown>
                                        ...
                                        <template #dropdown>
                                            <el-dropdown-menu>
                                                <el-dropdown-item @click="deleteChat(item.id)"><span style="color: red">Delete Chat</span></el-dropdown-item>
                                            </el-dropdown-menu>
                                        </template>
                                    </el-dropdown>
                                </div>
    ...
    <el-dialog v-model="showNoteContent" title="Notification" :close-on-click-modal="false" width="70%">
        <el-descriptions
                :column="3"
                border
            ...
            <template v-for="(item,index) in friendList" :key="index">
                ...
                <el-descriptions-item>
                    ...
                    <el-button type="success" @click="agreeApplyFriend(item.id)">Accept</el-button>
                    <el-button type="danger" @click="refuseApplyFriend(item.id)">Refuse</el-button>
                </el-descriptions-item>
            </template>
        </el-descriptions>
        ...
        <template #footer>
              <span class="dialog-footer">
                <el-button type="primary" @click="showNoteContent = false">Close</el-button>
              </span>
        </template>
    </el-dialog>
</template>
