<template>
    <div id="friends" class="sidebar active">
        <header>
            ...
            <ul class="list-inline">
                <li class="list-inline-item" data-toggle="tooltip" title="Add">
                        ...
                        <div class="users-list-body">
                            ...
                            <div>
                                <el-dropdown>
                                    ...
                                    <template #dropdown>
                                        <el-dropdown-menu>
                                            <el-dropdown-item @click="startNewChat(item.receiveUserDTO.id, item.id)">Start Chat</el-dropdown-item>
                                            <el-dropdown-item @click="openFriendProfileInfo(item.receiveUserDTO.id)">View Profile</el-dropdown-item>
                                            <div class="dropdown-divider"></div>
                                            <el-dropdown-item @click="deleteFriend(item.receiveUserDTO.id)"><span style="color: red">Delete</span></el-dropdown-item>
                                        </el-dropdown-menu>
                                    </template>
                                </el-dropdown>
                            </div>
    ...
    <el-dialog v-model="showApplyFriend" title="Add" :close-on-click-modal="false">
        <el-form :model="applyFriendData">
            ...
            <el-form-item label="Info" label-width="100px">
                <el-input v-model="applyFriendData.remark" placeholder="Enter Info" autocomplete="off"></el-input>
            </el-form-item>
        </el-form>
        <template #footer>
      <span class="dialog-footer">
        <el-button @click="showApplyFriend = false">Cancel</el-button>
        <el-button type="primary" @click="submitApplyFriend">Confirm</el-button>
      </span>
        </template>
    </el-dialog>
</template>
