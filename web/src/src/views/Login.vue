    ...
    <body class="form-membership">
        <div class="form-wrapper">
            ...
            <form>
                ...
                <router-link to="/register"><a href="javascript:void(0);" class="btn btn-outline-light btn-sm">Register Now!</a></router-link>
            </form>
            <!-- ./ form -->
...
export default {
    ...
    setup() {
        ...
        function login() {
            ...
            axios.post(process.env.VUE_APP_SERVER + "/web/user/login", data).then((response)=>{
